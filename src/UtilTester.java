...
public class UtilTester {
    ...
    public void testComplexNegativePower() {
        ...
        //assertEquals(1419857, MathUtils.raiseToPower(17, -5), delta);
        //assertEquals(62748517, MathUtils.raiseToPower(13, -7), delta);
        assertEquals(1/14348907, MathUtils.raiseToPower(3, -15), delta);
        assertEquals(1/1419857, MathUtils.raiseToPower(17, -5), delta);
        assertEquals(1/62748517, MathUtils.raiseToPower(13, -7), delta);
    }
